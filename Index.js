...
//Que4
console.log("Albert Einstein once said, 'A person who never made a mistake never tried anything new in life' ");
//Que5
const famousQueuote = "A person who never made a mistake never tried anything new in life";
...
// Que9
let favNum = 5;
let message = "Hi, My favourite number is ";
...
// Que11
let friends = ["Aliya", "Ayesha", "Anya", "Amal", "Aizal"];
console.log("My friends are " + friends);
friends.forEach((friends) => {
    console.log(friends);
});
// Que12
let specialMsg = "Hello, How are you ";
friends.forEach((friends) => {
    console.log(specialMsg + friends);
});
// Que13
let vehicles = ["Aeroplane", "Train", "Mercedes"];
vehicles.forEach((vehicles) => {
    console.log(`I want to travel by ${vehicles}`);
});
// Que14
let guestList = ["Maria", "Tayyaba", "Areej"];
guestList.forEach((guestList) => {
    console.log(`${guestList}, I invite you for dinner on Saturday`);
});
// Que15
console.log(`${guestList[1]} can't make it so as a replacement of her I'll call someone else`);
guestList[1] = "Tuba";
console.log("Updated guest list: " + guestList);
//   Que16
// adding new guests in the guest list
console.log("Adding Amna , Ali and Ammara to my guest list as I found bigger table");
...
console.log("I just found new dinner table won't arrive in time, so I have space for only 2 guests");
...
// Que18
let places = ["Multan", "Lahore", "Islamabad", "Faislabad"];
...
console.log("Reverse the order of the list again to get back to the original order");
places.reverse();
console.log(places);
...
// Que29
let favFruit = ['Kiwi', 'Mango', 'Strawberry'];
...
// Que30
let userName = ['John', 'Admin', 'Jane', 'Doe'];
...
// Que38
function describe_cities(city = 'Karachi', county = 'Pakistan') {
...
// Que45
let make_car = (manufacturer, model_name, color, extra_feature) => {
    let carInfo = {
        manufacturer,
        model_name,
        color
